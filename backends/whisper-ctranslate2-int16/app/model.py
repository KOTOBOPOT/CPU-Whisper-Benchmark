"""Whisper model implementation using CTranslate2 with int16 quantization."""
...
class WhisperModel:
    """Whisper model using CTranslate2 with int16 quantization."""
    ...
    def __init__(self, weights_path: Optional[Path]) -> None:
        ...
        logging.info("Compute type: int16 (optimized for Intel CPU with MKL)")
        
        try:
            # Load CTranslate2 model with int16 quantization
            # This is optimized for Intel CPUs with Intel MKL backend
            ...
            logging.info("Model loaded successfully on CPU with int16 quantization")
    ...
    def transcribe(self, audio_bytes: bytes, filename: str) -> str:
        """Transcribe audio using CTranslate2 Whisper model with int16 quantization.
