"""Whisper model implementation using CTranslate2 with int8 quantization."""
...
class WhisperModel:
    """Whisper model using CTranslate2 with int8_float32 quantization."""
    ...
    def __init__(self, weights_path: Optional[Path]) -> None:
        ...
        logging.info("Compute type: int8_float32 (quantized for CPU)")
        
        try:
            # Load CTranslate2 model with int8_float32 quantization
            # This is optimized for x86-64 CPUs with Intel MKL/oneDNN
            ...
            logging.info("Model loaded successfully on CPU with int8_float32 quantization")
    ...
    def transcribe(self, audio_bytes: bytes, filename: str) -> str:
        """Transcribe audio using CTranslate2 Whisper model with int8 quantization.
